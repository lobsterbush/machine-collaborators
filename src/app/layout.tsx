  ...
  return (
    <html lang="en">
      ...
      >
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[200] focus:px-4 focus:py-2 focus:bg-terracotta focus:text-white focus:text-sm focus:font-semibold"
        >
          Skip to content
        </a>
        <GrainOverlay />
